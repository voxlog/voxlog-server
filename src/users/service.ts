...
import { TopAlbum, TopArtist, UserCreateIn, UserLoginIn, UserOut } from './dtos';
...
export async function getTopAlbums(username: string, quantity: number): Promise<TopAlbum[]> {
  try {
